...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Yasin Labs — AI Automation Systems, Engineered" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Yasin Labs" },
      { property: "og:title", content: "Yasin Labs — AI Automation Systems, Engineered" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Space+Grotesk:wght@500;600;700&family=JetBrains+Mono:wght@400;500&family=Vazirmatn:wght@400;500;600;700&display=swap",
      },
    ],
  }),
